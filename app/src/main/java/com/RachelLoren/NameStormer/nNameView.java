...
public class nNameView extends AppCompatActivity {
    int name1Ref = 1;
    int name2Ref = 1;
    int name3Ref = 1;
    int name4Ref = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nname_view);

        configureBackBtn();
        //configureFavorites();

        int favNum = nNameGeneration.favNum;
        int ranNum = nNameGeneration.ranNum;
        int lettNum = nNameGeneration.lettNum;
