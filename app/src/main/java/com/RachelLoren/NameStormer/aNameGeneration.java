...
public class aNameGeneration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aname_generation);
        ...
        generate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                startActivity(new Intent(aNameGeneration.this, aNameView.class));
            }
        });
    }
