...
public class aNameView extends AppCompatActivity {
    int name1Ref = 1;
    int name2Ref = 1;
    int name3Ref = 1;
    int name4Ref = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aname_view);

        configureBackBtn();
        //configureFavorites();

        int favNum = aNameGeneration.favNum;
        int ranNum = aNameGeneration.ranNum;
        int lettNum = aNameGeneration.lettNum;
