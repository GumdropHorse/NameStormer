...
public class nNameGeneration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nname_generation);
        ...
        generate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                startActivity(new Intent(nNameGeneration.this, nNameView.class));
            }
        });
    }
